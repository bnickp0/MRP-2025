...
# Train
print("🚀 Training Logistic Regression with graph features...")
...
# Save
joblib.dump(model, r"C:\Users\bpanjehpour\Downloads\MRP\Dataset\split\lr_model_with_graph.pkl")
print("✅ Trained and saved lr_model_with_graph.pkl")
